...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/lazybar)](https://cran.r-project.org/package=lazybar)
[![Monthly_Downloads](http://cranlogs.r-pkg.org/badges/lazybar)](https://cran.r-project.org/package=lazybar)
[![Licence](https://img.shields.io/badge/licence-GPL--3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0.en.html)
[![R-CMD-check](https://github.com/FinYang/lazybar/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/FinYang/lazybar/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
[CRAN](https://cran.r-project.org/package=lazybar).

``` r
install.packages("lazybar")
```
